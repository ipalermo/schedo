...
public class HomeListenerService extends WearableListenerService
    ...
    private static final String TAG = Utils.makeLogTag("HomeListenerService");
    ...
    private void dismissPhoneNotification(final String sessionId) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Utils.LOGD(TAG, "dismissPhoneNotification(): Dismiss wearable notification");
                if (mGoogleApiClient.isConnected()) {
                    Utils.LOGD(TAG, "Deleting Uri is: " + putDataMapRequest.getUri().toString());
                            ...
                            .setResultCallback(new ResultCallback<DataApi.DeleteDataItemsResult>() {
                                ...
                                public void onResult(
                                    ...
                                    if (!deleteDataItemsResult.getStatus().isSuccess()) {
                                        Utils.LOGD(TAG, "dismissPhoneNotification(): failed to delete"
                                                + " the data item");
                                    }
                                }
                            });
    ...
    public void onConnected(Bundle bundle) {
        Utils.LOGD(TAG, "Connected to Google API Client");
        mConnected = true;
    }
