...
package com.ncode.android.apps.schedo.iowear;
...
import com.ncode.android.apps.schedo.iowear.utils.Utils;
import com.ncode.android.apps.schedo.iowear.fragments.FeedbackFragment;
import com.ncode.android.apps.schedo.iowear.fragments.RadioFragment;
import com.ncode.android.apps.schedo.iowear.fragments.StarFragment;
import com.ncode.android.apps.schedo.iowear.fragments.SubmitFragment;
...
public class PagerActivity extends Activity
    ...
    private static final String TAG = Utils.makeLogTag("PagerActivity");
    ...
    public void onQuestionAnswered(int questionNumber, int responseNumber) {
        Utils.LOGD(TAG, "Question Answered: " + questionNumber + " -> " + responseNumber);
                        ...
                        .setResultCallback(new ResultCallback<DataApi.DataItemResult>() {
                            ...
                            public void onResult(DataApi.DataItemResult dataItemResult) {
                                if (!dataItemResult.getStatus().isSuccess()) {
                                    Utils.LOGD(TAG, "Failed to send back responses, status: "
    ...
    private PutDataRequest buildDataRequest() throws JSONException {
        ...
        Utils.LOGD(TAG, "JSON representation of the response: " + response);
    ...
    public void onConnected(Bundle bundle) {
        Utils.LOGD(TAG, "onConnected() Connected to Google Api Service");
    }
