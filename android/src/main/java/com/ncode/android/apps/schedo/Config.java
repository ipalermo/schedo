...
public class Config {
    ...
    public static final String MASTER_MANIFEST_URL = PROD_MASTER_MANIFEST_URL;

    public static final String BOOTSTRAP_DATA_TIMESTAMP = "Thu, 10 Apr 2014 00:01:03 GMT";

    // Conference hashtag
    public static final String CONFERENCE_HASHTAG = "#schedo";
    ...
    public static final String CONFERENCE_HASHTAG_PREFIX = "#schedo";
    ...
    public static final long[][] CONFERENCE_DAYS = new long[][] {
            ...
            { ParserUtils.parseTime("2015-06-27T07:00:00.000Z"),
              ParserUtils.parseTime("2015-06-28T06:59:59.999Z") },
            // start and end of day 1
            { ParserUtils.parseTime("2015-05-27T07:00:00.000Z"),
                    ParserUtils.parseTime("2015-05-28T06:59:59.999Z") },
            // start and end of day 2
            { ParserUtils.parseTime("2015-05-28T07:00:00.000Z"),
                    ParserUtils.parseTime("2015-05-29T06:59:59.999Z") },
            // start and end of day 3
            { ParserUtils.parseTime("2015-05-29T07:00:00.000Z"),
                    ParserUtils.parseTime("2015-05-30T06:59:59.999Z") }
        };
    ...
    public static final String APP_NAME = "com.ncode.android.apps.schedo";
    public static final String API_KEY = "AIzaSyCEwYcHJG6QMwrMmq87Yjg3uhgODGeXm7g";

    // Announcements
    public static final String ANNOUNCEMENTS_PLUS_ID = "";

    // YouTube API config
    public static final String YOUTUBE_API_KEY = "AIzaSyCEwYcHJG6QMwrMmq87Yjg3uhgODGeXm7g";
    ...
    public static final String WIFI_SSID = "PalermoWIFI";
    public static final String WIFI_PASSPHRASE = "n33d2c0nf!rm";
    ...
    // Link to Schedo Extended events presented in Explore screen
