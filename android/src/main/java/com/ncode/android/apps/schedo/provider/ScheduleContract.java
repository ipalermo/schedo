...
import com.ncode.android.apps.schedo.util.ParserUtils;
...
public class ScheduleContract {
    ...
    interface SessionsColumns {
        ...
        /** Unique string identifying the event this session belongs to. */
    ...
    interface EventsColumns {
        /** Unique string identifying this session. */
        String EVENT_ID = "event_id";
        /** Difficulty level of the event. */
        String EVENT_LEVEL = "event_level";
        /** Start time of this track. */
        ...
        /** Body of text explaining this event in detail. */
        String EVENT_ABSTRACT = "event_abstract";
        /** Requirements that attendees should meet. */
        String EVENT_REQUIREMENTS = "event_requirements";
        /** Kewords/tags for this event. */
        String EVENT_KEYWORDS = "event_keywords";
        /** Hashtag for this event. */
        String EVENT_HASHTAG = "event_hashtag";
        /** The year the event takes place*/
        String EVENT_YEAR = "event_year";
        /** The list of start time and end time for each day of the event*/
        String EVENT_DAYS = "event_days";
        /** Full URL to event online. */
        String EVENT_URL = "event_url";
        /** Full URL to YouTube. */
        String EVENT_YOUTUBE_URL = "event_youtube_url";
        /** Full URL to PDF. */
        String EVENT_PDF_URL = "event_pdf_url";
        /** Full URL to official event notes. */
        String EVENT_NOTES_URL = "event_notes_url";
        /** User-specific flag indicating starred status. */
        String EVENT_IN_MY_SCHEDULE = "event_in_my_schedule";
        /** Key for event Calendar event. (Used in ICS or above) */
        String EVENT_CAL_EVENT_ID = "event_cal_event_id";
        /** The YouTube live stream URL. */
        String EVENT_LIVESTREAM_URL = "event_livestream_url";
        /** The Moderator URL. */
        String EVENT_MODERATOR_URL = "event_moderator_url";
        /** The set of tags the event has. This is a comma-separated list of tags.*/
        String EVENT_TAGS = "event_tags";
        /** The set of sessions the event has. This is a comma-separated list of session ids.*/
        String SESSION_TAGS = "session_tags";
        /** The names of the speakers on this event, formatted for display. */
        String EVENT_SPEAKER_NAMES = "event_speaker_names";
        /** The order (for sorting) of this event's type. */
        String EVENT_GROUPING_ORDER = "event_grouping_order";
        /** The hashcode of the data used to create this record. */
        String EVENT_IMPORT_HASHCODE = "event_import_hashcode";
        /** The event's main tag. */
        String EVENT_MAIN_TAG = "event_main_tag";
        /** The event's branding color. */
        String EVENT_COLOR = "event_color";
        /** The event's captions URL (for livestreamed events). */
        String EVENT_CAPTIONS_URL = "event_captions_url";
        /** The event interval when using the interval counter query. */
        String EVENT_INTERVAL_COUNT= "event_interval_count";
        /** The event's photo URL. */
        String EVENT_PHOTO_URL = "event_photo_url";
        /** The event's related content (videos and call to action links). */
        String EVENT_RELATED_CONTENT = "event_related_content";
    }
    ...
    public static final String CONTENT_AUTHORITY = "com.ncode.android.apps.schedo";
    ...
    /**
     * Each event has zero or more {@link Tags}, zero or more {@link Sessions},
     * .
     */
    public static class Events implements EventsColumns, SyncColumns, BaseColumns {
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.schedo2015.event";
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.schedo2015.event";
        ...
        // ORDER BY clauses
        public static final String SORT_BY_TYPE_THEN_TIME = EVENT_GROUPING_ORDER + " ASC,"
                + EVENT_DAYS + " ASC," + EVENT_TITLE + " COLLATE NOCASE ASC";
        public static final String SORT_BY_TIME = EVENT_DAYS + " ASC,"
                + EVENT_TITLE + " COLLATE NOCASE ASC";

        public static final String LIVESTREAM_SELECTION =
                EVENT_LIVESTREAM_URL + " is not null AND " + EVENT_LIVESTREAM_URL + "!=''";
...
*/
        ...
        /**
         * Build {@link Uri} that references any {@link Videos} associated
         * with the requested {@link #EVENT_ID}.
         */
        public static Uri buildVideosDirUri(String eventId) {
            return CONTENT_URI.buildUpon().appendPath(eventId).appendPath(PATH_VIDEOS).build();
        }

        /**
         * Build {@link Uri} that references any {@link Tags} associated with
         * the requested {@link #EVENT_ID}.
         */
    ...
    public static class Sessions implements SessionsColumns, RoomsColumns,
        ...
        public static Uri buildSessionUri(String eventId) {
            return CONTENT_URI.buildUpon().appendPath(eventId).build();
        }
