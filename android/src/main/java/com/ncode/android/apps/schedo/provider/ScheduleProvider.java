...
import com.ncode.android.apps.schedo.appwidget.ScheduleWidgetProvider;
import com.ncode.android.apps.schedo.provider.ScheduleContract.Announcements;
import com.ncode.android.apps.schedo.provider.ScheduleContract.PeopleIveMet;
import com.ncode.android.apps.schedo.provider.ScheduleContract.Blocks;
import com.ncode.android.apps.schedo.provider.ScheduleContract.Experts;
import com.ncode.android.apps.schedo.provider.ScheduleContract.Feedback;
import com.ncode.android.apps.schedo.provider.ScheduleContract.MapMarkers;
import com.ncode.android.apps.schedo.provider.ScheduleContract.MapTiles;
import com.ncode.android.apps.schedo.provider.ScheduleContract.Rooms;
import com.ncode.android.apps.schedo.provider.ScheduleContract.SearchSuggest;
import com.ncode.android.apps.schedo.provider.ScheduleContract.Sessions;
import com.ncode.android.apps.schedo.provider.ScheduleContract.Speakers;
import com.ncode.android.apps.schedo.provider.ScheduleContract.Tags;
import com.ncode.android.apps.schedo.util.SelectionBuilder;
...
import com.ncode.android.apps.schedo.provider.ScheduleDatabase.SessionsSearchColumns;
import com.ncode.android.apps.schedo.provider.ScheduleDatabase.SessionsSpeakers;
import com.ncode.android.apps.schedo.provider.ScheduleDatabase.Tables;
 ...
 * by {@link com.ncode.android.apps.schedo.sync.SyncHelper}, and queried by various
...
public class ScheduleProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (match) {
            ...
            case TAGS: {
                db.insertOrThrow(ScheduleDatabase.Tables.TAGS, null, values);
                notifyChange(uri);
            ...
            case ANNOUNCEMENTS: {
                db.insertOrThrow(ScheduleDatabase.Tables.ANNOUNCEMENTS, null, values);
                notifyChange(uri);
    ...
    private SelectionBuilder buildSimpleSelection(Uri uri) {
        ...
        switch (match) {
            ...
            case MAPMARKERS: {
                return builder.table(ScheduleDatabase.Tables.MAPMARKERS);
            }
            case MAPMARKERS_FLOOR: {
            ...
            case EXPERTS: {
                return builder.table(ScheduleDatabase.Tables.EXPERTS);
            }
            case EXPERTS_ID: {
            ...
            case PEOPLE_IVE_MET: {
                return builder.table(ScheduleDatabase.Tables.PEOPLE_IVE_MET);
            }
            case PEOPLE_IVE_MET_ID: {
            ...
            case PARTNERS: {
                return builder.table(ScheduleDatabase.Tables.PARTNERS);
            }
            case PARTNERS_ID: {
                final String partnerId = Partners.getPartnerId(uri);
                return builder.table(ScheduleDatabase.Tables.PARTNERS).where(Partners.PARTNER_ID + "=?", partnerId);
            }
            default: {
    ...
    private SelectionBuilder buildExpandedSelection(Uri uri, int match) {
        ...
        switch (match) {
            ...
            case ROOMS_ID_SESSIONS: {
                final String roomId = Rooms.getRoomId(uri);
                return builder.table(ScheduleDatabase.Tables.SESSIONS_JOIN_ROOMS)
            ...
            case SESSIONS: {
                ...
                return builder.table(ScheduleDatabase.Tables.SESSIONS_JOIN_ROOMS_TAGS, getCurrentAccountName(uri, true))
                        .mapToTable(Sessions._ID, ScheduleDatabase.Tables.SESSIONS)
                        .mapToTable(Sessions.ROOM_ID, ScheduleDatabase.Tables.SESSIONS)
            ...
            case SESSIONS_SEARCH: {
                ...
                return builder.table(ScheduleDatabase.Tables.SESSIONS_SEARCH_JOIN_SESSIONS_ROOMS, getCurrentAccountName(uri, true))
            ...
            case SESSIONS_AT: {
                ...
                return builder.table(ScheduleDatabase.Tables.SESSIONS_JOIN_ROOMS, getCurrentAccountName(uri, true))
                        .mapToTable(Sessions._ID, ScheduleDatabase.Tables.SESSIONS)
                        .mapToTable(Sessions.ROOM_ID, ScheduleDatabase.Tables.SESSIONS)
     ...
     * parent {@link com.ncode.android.apps.schedo.provider.ScheduleDatabase.Tables}. Used when needed to work around SQL ambiguity.
     */
