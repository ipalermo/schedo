...
public class SessionCalendarService extends IntentService {
    ...
    public static final String ACTION_ADD_SESSION_CALENDAR =
            "com.ncode.android.apps.schedo.action.ADD_SESSION_CALENDAR";
    public static final String ACTION_REMOVE_SESSION_CALENDAR =
            "com.ncode.android.apps.schedo.action.REMOVE_SESSION_CALENDAR";
    public static final String ACTION_UPDATE_ALL_SESSIONS_CALENDAR =
            "com.ncode.android.apps.schedo.action.UPDATE_ALL_SESSIONS_CALENDAR";
    public static final String ACTION_UPDATE_ALL_SESSIONS_CALENDAR_COMPLETED =
            "com.ncode.android.apps.schedo.action.UPDATE_CALENDAR_COMPLETED";
    public static final String ACTION_CLEAR_ALL_SESSIONS_CALENDAR =
            "com.ncode.android.apps.schedo.action.CLEAR_ALL_SESSIONS_CALENDAR";
    public static final String EXTRA_ACCOUNT_NAME =
            "com.ncode.android.apps.schedo.extra.ACCOUNT_NAME";
    public static final String EXTRA_SESSION_START =
            "com.ncode.android.apps.schedo.extra.SESSION_BLOCK_START";
    public static final String EXTRA_SESSION_END =
            "com.ncode.android.apps.schedo.extra.SESSION_BLOCK_END";
     ...
     * {@link com.ncode.android.apps.schedo.provider.ScheduleProvider}, adding or removing
