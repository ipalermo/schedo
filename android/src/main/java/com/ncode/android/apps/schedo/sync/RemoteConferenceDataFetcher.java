...
public class RemoteConferenceDataFetcher {
    ...
    public RemoteConferenceDataFetcher(Context context) {
        mContext = context;
        // By default, this class fetches from master manifest, but can be overriden by setManifestUrl() method
        mManifestUrl = Config.MASTER_MANIFEST_URL;
    }
    ...
    /**
     * Returns the remote manifest URL. This is stored as a resource in the app,
