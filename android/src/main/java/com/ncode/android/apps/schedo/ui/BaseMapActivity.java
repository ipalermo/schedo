...
import com.ncode.android.apps.schedo.nearby.MetadataResolver;
import com.ncode.android.apps.schedo.nearby.NearbyDeviceManager;
import com.ncode.android.apps.schedo.ui.widget.ScrimInsetsFrameLayout;
...
public abstract class BaseMapActivity extends BaseActivity implements NearbyFragment.Callbacks, ScrimInsetsFrameLayout.OnInsetsCallback {
    ...
    public static final String EXTRA_DETACHED_MODE
            = "com.ncode.android.apps.schedo.EXTRA_DETACHED_MODE";
