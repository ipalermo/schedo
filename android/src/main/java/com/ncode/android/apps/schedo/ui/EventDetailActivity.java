...
import com.ncode.android.apps.schedo.service.SessionAlarmService;
import com.ncode.android.apps.schedo.service.SessionCalendarService;
import com.ncode.android.apps.schedo.ui.widget.CheckableFrameLayout;
import com.ncode.android.apps.schedo.ui.widget.MessageCardView;
import com.ncode.android.apps.schedo.ui.widget.ObservableScrollView;
import com.ncode.android.apps.schedo.util.AccountUtils;
import com.ncode.android.apps.schedo.util.AnalyticsManager;
import com.ncode.android.apps.schedo.util.BeamUtils;
import com.ncode.android.apps.schedo.util.ImageLoader;
import com.ncode.android.apps.schedo.util.LogUtils;
import com.ncode.android.apps.schedo.util.SessionsHelper;
...
public class EventDetailActivity extends BaseActivity implements
        ...
        messageCardView.setListener(new MessageCardView.OnMessageCardButtonClicked() {
            ...
            public void onMessageCardButtonClicked(String tag) {
                if ("WATCH_NOW".equals(tag)) {
                    Intent intent = getWatchLiveIntent(EventDetailActivity.this);
                    startActivity(intent);
                } else {
    ...
    private void setupShareMenuItemDeferred() {
        mDeferredUiOperations.add(new Runnable() {
            @Override
            public void run() {
                new SessionsHelper(EventDetailActivity.this).tryConfigureShareMenuItem(mShareMenuItem,
            ...
            if (!TextUtils.isEmpty(speakerUrl)) {
                ...
                speakerImageView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        UIUtils.preferPackageForIntent(EventDetailActivity.this,
    ...
    /**
     * {@link com.ncode.android.apps.schedo.provider.ScheduleContract.Sessions} query parameters.
     */
