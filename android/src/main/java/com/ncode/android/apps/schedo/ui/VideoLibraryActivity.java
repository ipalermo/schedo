...
public class VideoLibraryActivity extends BaseActivity implements VideoLibraryFragment.Callbacks {
    ...
    private static final String STATE_KEY_YEAR = "com.ncode.android.apps.schedo.STATE_KEY_YEAR";
    private static final String STATE_KEY_TOPIC = "com.ncode.android.apps.schedo.STATE_KEY_TOPIC";
