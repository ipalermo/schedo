...
public class BitmapCache implements ImageLoader.ImageCache {
    private static final String TAG = LogUtils.makeLogTag(BitmapCache.class);
    ...
    public void addBitmapToCache(String data, Bitmap bitmap) {
        ...
        synchronized (mMemoryCache) {
            ...
            if (mMemoryCache.get(data) == null) {
                LogUtils.LOGD(TAG, "Memory cache put - " + data);
    ...
    public Bitmap getBitmapFromMemCache(String data) {
        if (data != null) {
            synchronized (mMemoryCache) {
                ...
                if (memBitmap != null) {
                    LogUtils.LOGD(TAG, "Memory cache hit - " + data);
                    return memBitmap;
                }
            }
            LogUtils.LOGD(TAG, "Memory cache miss - " + data);
        }
        return null;
    }
